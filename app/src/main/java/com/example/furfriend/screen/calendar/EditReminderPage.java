...
public class EditReminderPage extends AppCompatActivity {
            ...
            db.collection("reminders")
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        Map<String, Object> reminder = documentSnapshot.getData();
                        if (reminder != null) {
                            titleInput.setText((String) reminder.get("title"));
                            descriptionInput.setText((String) reminder.get("description"));
                            dateInput.setText((String) reminder.get("date"));
                            timeInput.setText((String) reminder.get("time"));
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(EditReminderPage.this, "Error loading reminder: " + e.getMessage(),
        ...
        db.collection(Constants.USERS)
            ...
            .addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    // Reload reminder data to set selected pets
                    loadReminderData();
                } else {
                    Toast.makeText(EditReminderPage.this, "Error loading pets: " + task.getException().getMessage(),
                                 Toast.LENGTH_SHORT).show();
                }
            });
    }
    ...
    private void saveReminder() {
        ...
        db.collection("reminders")
            ...
            .addOnSuccessListener(aVoid -> {
                Toast.makeText(EditReminderPage.this, "Reminder updated successfully",
                             Toast.LENGTH_SHORT).show();
                finish();
            })
            .addOnFailureListener(e -> {
                Toast.makeText(EditReminderPage.this, "Error updating reminder: " + e.getMessage(),
                             Toast.LENGTH_SHORT).show();
            });
    }
} 